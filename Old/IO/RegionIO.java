...
import com.GlitchyDev.Old.World.Region;
import com.GlitchyDev.Old.World.World;
...
public class RegionIO {
    ...
    public static void writeRegionToFile(Region region, File file) throws IOException {
    ...
    private boolean getByteValue(byte b, int pos) {
        return ((b >> (pos - 1)) & 1) == 1;
    }
